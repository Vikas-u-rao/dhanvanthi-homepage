...
export default function Footer({ onEnquireClick }: FooterProps) {
  ...
  return (
    <footer className="w-full flex flex-col mt-auto">
      ...
      <div className="w-full bg-white px-6 py-10 md:px-16 md:py-14 border-t border-[#ececf0]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start md:justify-between gap-8 md:gap-12">
          ...
          <div className="flex justify-center md:justify-start w-full md:w-1/3">
            <img 
              ...
              className="max-h-[80px] md:max-h-[100px] object-contain select-none" 
          ...
          <div className="flex flex-col text-center md:text-left gap-1.5 md:w-1/3">
            <span className="font-chopin text-[#ca9731] text-[13px] md:text-[14px] tracking-[0.1em] font-semibold uppercase">
              Visit
            </span>
            <p className="font-chopin text-[#638038] text-[15px] md:text-[16px] tracking-[-0.3px] leading-relaxed">
          ...
          <div className="flex flex-col text-center md:text-left gap-2 md:w-1/3">
            ...
            <a 
              ...
              className="font-chopin text-[#638038] text-[15px] md:text-[16px] tracking-[-0.3px] hover:underline"
            >
              {SALES_PHONE_DISPLAY}
            </a>
            {/* Social links — renders only when official URLs are configured in src/lib/social.ts */}
      ...
      {/* Copyright Bar — reduced size for clean hierarchy */}
      <div className="w-full bg-[#f2f6df] py-4 px-4 text-center border-t border-[#ececf0]/20">
        <p className="font-inter text-[#638038] text-[11px] md:text-[12px] tracking-[0.02em]">
