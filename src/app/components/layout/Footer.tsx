...
export default function Footer({ onEnquireClick }: FooterProps) {
  return (
    <footer className="w-full flex flex-col mt-auto">
      ...
      <div className="relative w-full py-16 md:py-24 bg-black/50 text-center overflow-hidden flex flex-col items-center justify-center min-h-[431px]">
        {/* Background Image with vertical scale and rotate */}
      ...
      <div className="w-full bg-white px-6 py-12 md:px-16 md:py-16 border-t border-[#ececf0]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start md:justify-between gap-8 md:gap-12">
          ...
          <div className="flex flex-col text-center md:text-left gap-2 md:w-1/3">
            <span className="font-chopin text-[#ca9731] text-[18px] md:text-[20px] tracking-[-0.4px] font-medium uppercase select-none">
              Visit
            </span>
            <p className="font-chopin text-[#638038] text-[18px] md:text-[20px] tracking-[-0.4px] leading-relaxed">
          ...
          <div className="flex flex-col text-center md:text-left gap-2 md:w-1/3">
            ...
            <a 
              ...
              className="font-chopin text-[#638038] text-[18px] md:text-[20px] tracking-[-0.4px] hover:underline"
            >
              +91 73985 73985
            </a>
          </div>
